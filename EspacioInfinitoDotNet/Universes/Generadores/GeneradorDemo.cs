...
{
    public class GeneradorDemo : Generador
    {
        public const int TamanioEnSectores = 256;
        ...
        {
            return "GeneradorDemo";
        }

        public override string Descripcion()
        {
            return "Genera la galaxia que se utiliza en la demo del juego";
        }
        ...
        private Bitmap InicializarBitmap()
        {
            ...
            foreach (Faccion faccion in facciones)
            {
                ...
                int cantidadSectores = rndCreacionSectores.Next(100, 200);
        ...
        public override Sector CrearSector(SectorID sectorID)
        {
            ...
            bool puedeTenerNaves = (rndCreacionSectores.Next(0, 5) == 0);
